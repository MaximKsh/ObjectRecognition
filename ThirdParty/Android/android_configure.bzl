...
_ANDROID_NDK_HOME = "/home/maxim/Android/Sdk/ndk/20.1.5948944/"
_ANDROID_SDK_HOME = "/home/maxim/Android/Sdk/"
...
def _android_autoconf_impl(repository_ctx):
    ...
    repository_ctx.template(
        "BUILD",
        Label("//ThirdParty/Android:android_configure.BUILD.tpl"),
    )
    repository_ctx.template(
        "android.bzl",
        Label("//ThirdParty/Android:android.bzl.tpl"),
        substitutions = {
