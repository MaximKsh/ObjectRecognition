...
http_archive(
    ...
    patches = [
        "@mediapipe_repository//third_party:org_tensorflow_e3a7bdbebb99352351a19e2e403136166aa52934.diff",
    ],
...
http_archive(
    name = "ios_opencv",
    build_file = "@mediapipe_repository//third_party:opencv_ios.BUILD",
...
http_archive(
    ...
    build_file = "@mediapipe_repository//third_party:google_toolbox_for_mac.BUILD",
